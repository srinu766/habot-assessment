  ...
  return (
    <div className="container mx-4 flex flex-col items-center bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="flex flex-col items-center p-6 rounded-lg transition-transform transform hover:scale-105" style={{ backgroundColor: "#E8FBFF", width: '350px' }}>
          <div className="text-4xl mb-4">👤</div>
          <h3 className="text-center font-medium">Select Your Role and <br /> Sign Up</h3>
        </div>

        <div className="flex flex-col items-center p-6 rounded-lg transition-transform transform hover:scale-105" style={{ width: '350px' }}>
          <div className="text-4xl mb-4">📝</div>
